...
class MY_Session {
    ...
    function __construct() {
        ...
        $this->_sess_table = $this->object->db->dbprefix . $this->object->config->item('sess_table_name');
            ...
            if ($subitem == 'session_id') { //added forbackward-compatibility                                                                           
                ...
                if (isset($_SESSION[$item])) {
                    if (is_array($_SESSION[$item]))
                        return (!isset($_SESSION[$item][$subitem])) ? false : $_SESSION[$item][$subitem];
                    if (is_object($_SESSION[$item]))
                        return(!isset($_SESSION[$item]->$subitem)) ? false : $_SESSION[$item]->$subitem;
                    return false;
                }
            }
    ...
    function _open() {
        if ($this->_sess_db = mysql_connect($this->object->db->hostname, $this->object->db->username, $this->object->db->password)) {
